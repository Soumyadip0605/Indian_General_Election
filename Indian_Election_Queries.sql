...
--1. Find the total number of parliament seats?
...
Select 
   Constituencywise_Details.Candidate_Name,
   Constituencywise_Details.Party_Name,
...
Where 
    Constituencywise_Results.Constituency_Name = 'KOLKATADAKSHIN'
